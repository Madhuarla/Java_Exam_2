...
public class Answer9 {
    ...
    public static void main(String[] args) {
        ...
        PersonalPlane personalPlane = new PersonalPlane("Jumbo jet","Personal plane",16,
                "5 star hotel",265,3);
        System.out.println(fighterJet.printData());
        System.out.println(passengerPlane.printData());
        System.out.println(personalPlane.printData());
    }
}
interface AirplaneMethods{
    String printData();
}
class Airplane implements AirplaneMethods{
    private String name;
    private String type;
...
class FighterJet extends Airplane implements AirplaneMethods{
    ...
    @Override
    public String printData() {
        return super.printData()+" "+"FighterJet{" +
                "speed=" + speed +
                '}';
    }
}
class PassengerPlane extends Airplane implements AirplaneMethods{
    ...
    @Override
    public String printData() {
        return super.printData()+" "+"PassengerPlane{" +
                "capacity=" + capacity +
...
class PersonalPlane extends Airplane{
    ...
    @Override
      public String printData() {
        return super.printData()+" "+"PersonalPlane{" +
                "capacity=" + capacity +
